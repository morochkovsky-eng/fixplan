...
export const unreadableReceiptReply = "Не удалось надёжно прочитать квитанцию: изображение слишком размыто или сжато, либо данные требуют ручной проверки. Сделайте более чёткое фото при хорошем освещении или отправьте оригинал как файл без сжатия. Если был прежний черновик, его подтверждение закрыто.";
