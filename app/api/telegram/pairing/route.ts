...
export async function GET() {
  ...
  const { data, error } = await access.admin.from("telegram_accounts").select("telegram_user_id,display_name,username,active,created_at").eq("apartment_id", APARTMENT_ID).order("created_at", { ascending: false });
